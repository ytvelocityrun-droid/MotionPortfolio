        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Professional storytelling through high-quality video editing. I focus 
                on clean cuts, perfect pacing, and cinematic color grading to make 
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Creating dynamic visual experiences with advanced motion graphics 
                and 3D animations. From smooth transitions to complex character 
                movement.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
